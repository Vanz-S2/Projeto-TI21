...
<section>
    ...
    <div class="site">
        ...
        <div class="infoAcademia">
            ...
            <img src="img/icones/logoVivaBem.svg" alt="Logo da academia">

            <ul>
                <li>
                    <a href="#">
                        <img src="img/icones/iconeFacebook.svg" alt="Rede social da academia">
                    </a>
                </li>

                <li><a href="#"><img src="img/icones/iconeInstagram.svg" alt="Rede social da academia"></a></li>
                <li><a href="#"><img src="img/icones/iconeWhatsVerde.svg" alt="Rede social da academia"></a>
                </li>
            </ul>
