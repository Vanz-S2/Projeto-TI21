...
//a variável "$aluno" está chamando o método guardado no "Listar()" e atribuindo a variável "$lista"
$lista = $aluno->Listar();
        ...
        <tbody>
            ...
            <?php foreach ($lista as $linha): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);"
                            href="index.php?p=alunos&alu=atualizar">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <td><a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);"
                            href="index.php?p=alunos&alu=desativar">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
