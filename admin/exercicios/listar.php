        ...
        <tbody>
            ...
            <?php foreach ($lista as $linha) : ?>
                ...
                <tr>
                    ...
                    <td><a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=exercicios&e=desativar&id=<?php echo $linha['idExercicio'] ?>" onclick="return confirmarDesativacao()">
